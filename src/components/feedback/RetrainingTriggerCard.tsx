...
export function RetrainingTriggerCard({ trigger, onToggle, onTriggerManually }: RetrainingTriggerCardProps) {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground capitalize">{trigger.thresholdType.replace('_', ' ')}</p>
            </div>
          </div>
          <Switch 
      ...
      <CardContent className="space-y-3">
        ...
        <div className="p-3 bg-secondary/50 rounded-lg font-mono text-xs">
          ...
          <code className="text-primary">
            ...
            {' '}over {trigger.condition.windowPeriod}
        ...
        {trigger.lastTriggered && (
          <p className="text-xs text-muted-foreground">
            Last triggered: {new Date(trigger.lastTriggered).toLocaleDateString()}
          </p>
        )}
