      ...
      <div className="p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Analytics & Monitoring</h1>
              <p className="text-muted-foreground">Track platform performance and student engagement</p>
            </div>
          </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">24,562</p>
              ...
              <CardContent>
                <div className="space-y-4">
                  {agentPerformance.map((agent) => (
                    <div key={agent.name} className="flex items-center gap-4 p-4 bg-secondary/50 rounded-lg">
                        ...
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <Badge 
                              ...
                              variant={agent.trend === 'stable' ? 'secondary' : 'default'}
                            >
                              {agent.trend === 'up' && <ArrowUp className="w-3 h-3 mr-1" />}
                              {agent.trend === 'down' && <ArrowDown className="w-3 h-3 mr-1" />}
