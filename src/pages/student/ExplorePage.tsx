    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            type: 'course',
            children: [
              { id: 'agent-3', name: 'Algebra Tutor', type: 'agent' },
            ],
          },
        ],
      },
        ...
        children: [
          {
            ...
            children: [
              ...
              { id: 'agent-6', name: 'Literary Analysis Helper', type: 'agent' },
            ],
          },
        ],
      },
...
function FolderItem({ node, depth = 0 }: { node: FolderNode; depth?: number }) {
  ...
  if (node.type === 'agent') {
    return (
      ...
      >
        <div className={cn("w-8 h-8 rounded-lg flex items-center justify-center", typeColors[node.type])}>
    ...
    <StudentLayout>
      <div className="p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-1">Browse all your classes, subjects, and AI teachers</p>
        </div>
